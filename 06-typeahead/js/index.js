  ...
  function displayMatches() {
    ...
    const newHtml = matchArr
      .map(place => {
        ...
        <a href="http://www.google.com/search?q=${place.city},%20${
          place.state
        }" target=_blank>
        <span class="name">${hlCity}, ${hlState}</span></a>
        <span class="population">${prettyPop}</span></li>`;
      })
      .join("");
